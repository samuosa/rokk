...
<template>
  <section id="lineup" class="border-b-4 border-primary px-margin-mobile py-12 md:px-margin-desktop md:py-[72px]">
    ...
    <div class="grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-gutter">
      ...
      >
        ...
        <h3 class="m-0 border-b-4 border-current pb-3 font-display text-headline-lg uppercase [text-wrap:balance]">
          {{ slot.band.name }}
        </h3>
